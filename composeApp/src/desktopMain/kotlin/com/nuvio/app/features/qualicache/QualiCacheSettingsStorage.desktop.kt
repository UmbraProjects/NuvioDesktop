...
internal actual object QualiCacheSettingsStorage {
    ...
    private const val minimumTrustKey = "qualicache_minimum_trust"
    ...
    actual fun loadMinimumTrust(): String? = loadString(minimumTrustKey)
    actual fun saveMinimumTrust(minimumTrust: String) = saveString(minimumTrustKey, minimumTrust)
