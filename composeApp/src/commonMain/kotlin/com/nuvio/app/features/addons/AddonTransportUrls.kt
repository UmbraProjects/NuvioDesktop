...
/**
 * Percent-encodes characters that are unsafe in an HTTP URL but commonly appear unescaped in
 * addon/manifest URLs (e.g. `|` in Torrentio debrid configs, spaces, backslashes). Already-escaped
 * sequences and normal characters are left untouched, so it is safe to apply to a full URL.
 */
